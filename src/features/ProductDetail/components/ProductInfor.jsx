...
function ProductInfor(props) {
    ...
    return (
        <div>    
            <h4 className="ProductName">Laptop APPLE MacBook Pro 2020 MYD92SA/A ( 13.3\" Apple M1/8GB/512GB SSD/macOS/1.4kg)</h4>
            <h5 className="ProductBand"> 
            <i class="fab fa-apple"></i>
            Apple
            </h5>
            <p className="ProductDescription">LaptopMacBook Pro 2020 13.3" Z11B000CT (M1/16GB/SSD256GB) (Xám) là sản phẩm nổi bật của MacBook. Sở hữu những điểm nổi bật độc đáo của riêng dòng MacBook Pro và hiệu năng đỉnh cao với chip Apple M1, chiếc Laptop này mang đến cho bạn khả năng xử lý các tác vụ nặng nhanh chóng, mượt mà.</p>
